...
import { EXERCISE_AUTOCOMPLETE_OPTIONS, getExerciseProgressionRule, normalizeExerciseCanonicalName } from '@/shared/exerciseLibrary';
...
export { EXERCISE_AUTOCOMPLETE_OPTIONS, getExerciseProgressionRule, normalizeExerciseCanonicalName };
